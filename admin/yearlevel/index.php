...
<?php 
  ...
  if(isset($_GET['update'])){
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql = "UPDATE `tbllevel` SET `YEARLEVEL`='$yearlevel' WHERE LEVELID='$id'";
  ...
  elseif(isset($_GET['delete'])){
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql = "DELETE FROM tbllevel WHERE LEVELID='$id'";
      if(mysqli_query($db, $sql)){
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      $sql = "INSERT INTO `tbllevel`(`YEARLEVEL`) VALUES ('$yearlevel')";
