...
if(isset($_GET['update'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "UPDATE `tblsection` SET `SECTION`='$section' WHERE SECTIONID='$id'";
...
elseif(isset($_GET['delete'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "DELETE FROM tblsection WHERE SECTIONID='$id'";
    if(mysqli_query($db, $sql)){
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO `tblsection`(`SECTION`) VALUES ('$section')";
