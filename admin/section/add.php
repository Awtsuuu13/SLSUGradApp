          ...
          <div class="card-body">
          		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for="DEPARTMENT_NAME"><strong>Section:</strong></label>

                      <div class="col-md-8">
                       
                         <input class="form-control input-sm" id="DEPARTMENT_NAME" name="section" placeholder="Section" type="text" value="" required="">
                      </div>
                    </div>
                  </div>
